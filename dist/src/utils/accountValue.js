...
exports.calculateAccountValue = void 0;
const math_1 = require("./math");
const sameDay = (timestamp1, timestamp2) => {
...
const calculateAccountValue = (positions, previousAccountValue) => {
    ...
    accountValue.day_gain_percent = math_1.calculatePercentChange(totalMktValue, accountValue.previous_day_mkt_value);
    accountValue.total_gain_percent = math_1.calculatePercentChange(totalMktValue, totalMktValue - accountValue.total_gain_total);
    return accountValue;
};
exports.calculateAccountValue = calculateAccountValue;
